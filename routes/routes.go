...
func (b *APIBuilder) AttachV1Routes() *mux.Router {
	...
	teamsRouter.HandleFunc("/boss/{boss}", b.server.RemoveTeammateByBoss).Methods("DELETE")
	teamsRouter.HandleFunc("/id/{run_id}", b.server.RemoveTeammateByRunId).Methods("DELETE")
